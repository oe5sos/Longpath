// =================================================================
// third_party/wdsp/src/rnnr.c  (NereusSDR)
// =================================================================
//
// Ported from Thetis source:
//   Project Files/Source/wdsp/rnnr.c @ v2.10.3.13 (commit 501e3f51)
//   Byte-for-byte import. No algorithmic changes. Original license
//   header (GPLv2+ + Samphire dual-licensing statement) preserved
//   verbatim below. Links against Xiph rnnoise (BSD 3-clause) —
//   vendored separately in third_party/rnnoise/.
// =================================================================
