// no-port-check: Longpath-original. See TciVfoCoalescer.h for cite chain.

// src/core/TciVfoCoalescer.cpp  (Longpath)
// Longpath-original — TCI VFO coalescer implementation.
//
