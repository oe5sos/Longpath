...
//
// Ported from AetherSDR src/core/KiwiSdrClient.h [@31b29583].
...
signals:
    void stateChanged(Longpath::KiwiSdrClient::State state,
    ...
    void telemetryChanged(const Longpath::KiwiSdrReceiverTelemetry& telemetry);
...
Q_DECLARE_METATYPE(Longpath::KiwiSdrReceiverTelemetry)
Q_DECLARE_METATYPE(Longpath::KiwiSdrClient::State)
