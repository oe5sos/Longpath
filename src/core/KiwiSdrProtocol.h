...
//                fremden Geraeten, und jede eigene Idee darin ist ein
//                Fehler, der erst am Empfaenger auffaellt.
// =================================================================
...
Q_DECLARE_METATYPE(Longpath::KiwiSdrProtocol::MeterReading)
Q_DECLARE_METATYPE(Longpath::KiwiSdrProtocol::ReceiverMetadata)
Q_DECLARE_METATYPE(Longpath::KiwiSdrProtocol::ProtocolState)
