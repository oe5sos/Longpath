                                          ...
                                          QSlider* slider, QLabel* valueLabel)
{
    ...
    if (valueLabel != nullptr) {
        valueLabel->setStyleSheet("QLabel { color: #4a7ba8; font-size: 13px; "
...
QHBoxLayout* SetupPage::addLabeledToggle(QLayout* parent, const QString& label, QPushButton* toggle)
{
    ...
    toggle->setStyleSheet(Style::themed(
        ...
        "border: 1px solid %1; }").arg(QLatin1String(Style::kDspToggleBorder)));
...
{
    value->setStyleSheet("QLabel { color: #4a7ba8; font-size: 13px; font-weight: bold; }");
