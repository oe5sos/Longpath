...
//
// Ported from AetherSDR src/gui/KiwiRebindTracker.h [@31b29583].
//   Copyright (C) 2024-2026  Jeremy (KK7GWY) / AetherSDR contributors
//       per https://github.com/ten9876/AetherSDR (GPLv3)
//
//   2026-08-23 — Portiert. Nur der Namensraum ist angepasst, sonst
//                zeichengetreu.
//
// ── Warum das schon jetzt hier liegt, obwohl es niemand ruft ────────
//
// Der Zustandsautomat gehoert zu Stufe 7 (Bandrueckruf) und wird bis
// dahin von nichts benutzt. Portiert ist er trotzdem, weil Aethers
// eigener Pruefstand dafuer bereitliegt und weil das Wissen darin
// nicht aus dem Code stammt, sondern aus dem Betrieb: dass FLEX bei
// einem Bandrueckruf die Scheibe WEGWIRFT und neu anlegt statt sie
// umzustimmen, findet man nicht durch Nachdenken heraus. Das
// Nachziehen der Pruefung sichert genau dieses Wissen.
