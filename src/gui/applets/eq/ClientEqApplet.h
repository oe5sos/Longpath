...
// =================================================================
// src/gui/applets/eq/ClientEqApplet.h  (Longpath)
// =================================================================
//
// Longpath-original stand-in for one enum from AetherSDR
...
// Longpath has no use for — it is the receive-side equaliser panel,
// and Longpath's receive path goes through WDSP with its own applet.
//
...
// its neighbour.
//
// Rx is kept even though Longpath never selects it, because removing
