...
- [GGMORSE-PROVENANCE.md](GGMORSE-PROVENANCE.md) — ggmorse (MIT, Georgi Gerganov) vendored byte-identical at `third_party/ggmorse/`, the CW decoder behind `src/core/CwDecoder`
