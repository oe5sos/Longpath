...
//
// Portiert aus AetherSDR tests/kiwi_sdr_trace_math_test.cpp [@31b29583],
...
{
    return Longpath::KiwiSdrTraceMath::estimateTraceFloorDbm(bins, kMinDbm);
}
...
int main()
{
    using namespace Longpath::KiwiSdrTraceMath;
