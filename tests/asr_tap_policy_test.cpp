...
//
// Ported from AetherSDR tests/asr_tap_policy_test.cpp [@31b29583].
//   Copyright (C) 2024-2026  Jeremy (KK7GWY) / AetherSDR contributors
//       per https://github.com/ten9876/AetherSDR (GPLv3)
//
//   2026-08-23 — Portiert. Nur der Namensraum ist angepasst, sonst
//                zeichengetreu — bei fremder Logik ist Treue wichtiger
//                als Hausstil.
...
int main(int argc, char** argv)
{
    ...
    Longpath::testLocksOntoOneSource();
    Longpath::testAnySourceMayClaimTheLock();
    Longpath::testSilentSourceReleasesTheLock();
    Longpath::testResetDropsTheLock();
    Longpath::testMonoCollapse();
    Longpath::testMonoCollapseGuardsAgainstNonFiniteAndClipping();
    Longpath::testMonoCollapseEdgeCases();
    Longpath::testNoSamplesAreDropped();

    if (Longpath::g_failures == 0)
        std::fprintf(stderr, "asr_tap_policy_test: all checks passed\n");
    return Longpath::g_failures == 0 ? 0 : 1;
}
