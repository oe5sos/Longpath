// =================================================================
// tests/tst_pgxl_connection_keepalive.cpp  (Longpath)
// =================================================================
// Longpath-native test. No AetherSDR equivalent (keepalive is a
// Longpath Tier 2 addition per design doc §2 and §6.4).
