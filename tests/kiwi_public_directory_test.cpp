...
//
// Portiert aus AetherSDR tests/kiwi_public_directory_test.cpp [@31b29583],
...
using Longpath::KiwiPublicDirectory;
using Longpath::KiwiPublicReceiver;
using ApiPolicy = Longpath::KiwiPublicReceiver::ApiPolicy;
